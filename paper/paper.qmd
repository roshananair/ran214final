...
#subtitle: "Recreating Fig. 3 from Schaefer et al. (2000)
format: html
---
...
# Methods 
The following methods take the moving 9 week average of each ion concentration and add them to a new table, pivot, then plot that table. This DOES NOT use the moving average function created prior.
